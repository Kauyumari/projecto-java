...
public class VentanaF_C extends JFrame implements ActionListener, KeyListener{
...
setTitle("Busqueda_Por_Codigo");
setIconImage(new ImageIcon(getClass().getResource("logo.jpg")).getImage());
getContentPane().setBackground(Color.WHITE);

VentanaE ventP = new VentanaE();
Datos = ventP.BaseDatos;
Recopilacion = ventP.eleccion;

etiqueta1 = new JLabel("Ingrese el código: ");
...
JOptionPane.showMessageDialog(null, "El código que buscas no está registrado");
