...
public class VentanaI extends JFrame implements ItemListener, MouseListener{

public JLabel etiqueta1, etiqueta2, etiqueta3, ayuda;
public JComboBox <String> combo;
public JTextArea areaTexto;
public String existencias, Seleccion;
public static String Datos[] = new String[201];
public int x;
...
VentanaE p = new VentanaE();
Datos = p.BaseDatos;

VentanaH i = new VentanaH();
existencias = i.dhl;
...
etiqueta1 = new JLabel("Búsqueda de existencias:");
etiqueta1.setBounds(10, 10, 150, 20);
add(etiqueta1);

etiqueta2 = new JLabel("Código: ");
etiqueta2.setBounds(10, 30, 150, 20);
add(etiqueta2);

combo = new JComboBox <String> ();
combo.setBounds(170, 30, 150, 20);
add(combo);
...
etiqueta3 = new JLabel("Artículo:");
etiqueta3.setBounds(10, 50, 150, 20);
add(etiqueta3);

areaTexto = new JTextArea();
areaTexto.setBounds(10, 70, 350, 250);
add(areaTexto);
...
JOptionPane.showMessageDialog(null, "En esta ventana puedes verificar las existencias");
